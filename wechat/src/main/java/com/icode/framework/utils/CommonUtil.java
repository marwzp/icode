...
/**
 * 通用工具
 * TODO javadoc for com.icode.framework.utils.CommonUtil
...
public class CommonUtil {
    ...
    public static AccessToken getToken(String appid, String appsecret) {
        ...
        String requestUrl = WechatConstant.ACCEESS_TOKEN_URL.replace("APPID",appid).replace("APPSECRET",appsecret);
