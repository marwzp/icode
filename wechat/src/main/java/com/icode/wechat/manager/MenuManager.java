...
package com.icode.wechat.manager;
...
import com.icode.wechat.entity.widget.menu.Button;
import com.icode.wechat.entity.widget.menu.CommonButton;
import com.icode.wechat.entity.widget.menu.ComplexButton;
import com.icode.wechat.entity.widget.menu.Menu;


/**
 * 菜单管理器
 * TODO javadoc for com.icode.wechat.manager.MenuManager
...
public class MenuManager {
	...
	public static void main(String[] args) {
		//从数据库中获取有效Token凭证
		Map<String, Object> map = AccessTokenUtil.getToken();
